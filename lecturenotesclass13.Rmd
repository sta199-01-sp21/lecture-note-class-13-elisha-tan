...
boot_medians
```
With 95% confidence, the true median rent price of one-bedroom apartments in Manhattan based on this sample of 20 apartments is between 2,162 and 2,875 dollars.
...
- Population: All mice that were not on treatment
- Parameter of interest: Proportion of mice that died
- Sample: Mice used in the experiment
